...
def optimize():
    ...
    data = DrugDrugData('kiba_cliff_pairs_ta1_ts0.9_cb_wt.csv')
...
sweep_config = {
    ...
    'parameters': {
        ...
        'dr': {'values': [0.01, 0.05, 0.1, 0.3, 0.5]},
    }
}

wandb.login(key='fd8f6e44f8d81be3a652dbd8f4a47a7edf59e44c')
sweep_id = wandb.sweep(sweep_config, project='sweep_3_cb')
wandb.agent(sweep_id=sweep_id, function=optimize, count=100)
